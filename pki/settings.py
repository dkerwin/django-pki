...
# base directory for pki storage (should be writable)
# defaults to PKI_APP_DIR/PKI
...
PKI_OPENSSL_TEMPLATE = getattr(settings,
...
# Graphviz PNG's to show relations
...
# enable email delivery: Certificates with defined email address
