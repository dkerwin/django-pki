...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'KeyUsage', fields ['name']
        db.create_unique('pki_keyusage', ['name'])

        # Adding unique constraint on 'ExtendedKeyUsage', fields ['name']
        db.create_unique('pki_extendedkeyusage', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ExtendedKeyUsage', fields ['name']
        db.delete_unique('pki_extendedkeyusage', ['name'])

        # Removing unique constraint on 'KeyUsage', fields ['name']
        db.delete_unique('pki_keyusage', ['name'])
