...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Certificate.pem_encoded'
        db.delete_column('pki_certificate', 'pem_encoded')

        # Deleting field 'CertificateAuthority.pem_encoded'
        db.delete_column('pki_certificateauthority', 'pem_encoded')


    def backwards(self, orm):
        
        # Adding field 'Certificate.pem_encoded'
        db.add_column('pki_certificate', 'pem_encoded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CertificateAuthority.pem_encoded'
        db.add_column('pki_certificateauthority', 'pem_encoded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
