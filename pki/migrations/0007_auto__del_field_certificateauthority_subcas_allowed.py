...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CertificateAuthority.subcas_allowed'
        db.delete_column('pki_certificateauthority', 'subcas_allowed')


    def backwards(self, orm):
        
        # Adding field 'CertificateAuthority.subcas_allowed'
        db.add_column('pki_certificateauthority', 'subcas_allowed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
