...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CertificateAuthority.type'
        db.delete_column('pki_certificateauthority', 'type')


    def backwards(self, orm):
        
        # Adding field 'CertificateAuthority.type'
        db.add_column('pki_certificateauthority', 'type', self.gf('django.db.models.fields.CharField')(default='RootCA', max_length=32, null=True), keep_default=False)
