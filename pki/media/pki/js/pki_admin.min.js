...
b){$(b).removeAttr("disabled")});$("#x509extension_form :input:not(:submit, :hidden)").each(function(a,b){$(b).removeAttr("disabled")})})}else{$("input[id=id_action_1]").attr("disabled","disabled");$("input[id=id_action_2]").attr("disabled","disabled");$("input[id=id_action_3]").attr("disabled","disabled");$("label[for=id_passphrase_verify]").addClass($("label[for=id_passphrase]").attr("class"));onParentChange();onCnChange();$("#id_parent").change(onParentChange);$("#id_common_name").bind("change keyup",
onCnChange);$("#id_passphrase").bind("change keyup focus",{a:"#id_passphrase",b:"#id_passphrase_verify"},onPfChange);$("#id_passphrase_verify").bind("change keyup focus",{a:"#id_passphrase",b:"#id_passphrase_verify"},onPfChange)}}else window.__pki_model__=="x509extension"&&window.__pki_add__!="True"&&$("#x509extension_form :input:not(:submit, :hidden)").each(function(a,b){$(b).attr("disabled","disabled");$(b).css("background-color","#F2F2F2")})});
