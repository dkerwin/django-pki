$(document).ready(function(){$("[id^=email_delivery_]").tipsy({html:true});$("[id^=chain_link_]").tipsy({html:true});$("[id^=tree_link_]").tipsy({html:true});$("[id^=download_link_]").tipsy({html:true});$("[id^=show_child_certs_]").tipsy({html:true});$("[id^=active_]").tipsy({html:true});if(typeof UpdateTime==="function"){UpdateTime();setInterval(UpdateTime,1E3)}if($("input[id=id_pkcs12_encoded]")){$("#id_pkcs12_passphrase").bind("change keyup focus",{a:"#id_pkcs12_passphrase",b:"#id_pkcs12_passphrase_verify"},
...
onPfChange);$("#id_passphrase_verify").bind("change keyup focus",{a:"#id_passphrase",b:"#id_passphrase_verify"},onPfChange)}});
